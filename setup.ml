...
(* OASIS_START *)
(* DO NOT EDIT (digest: a47d8fc6ba95b4457ce997a09ee2facc) *)
(*
...
let setup_t =
  {
            ...
            [
               Library
                 ({
                   ...
                   {
                      lib_modules = ["RaftMonitor"; "RaftMonitorWrapper"];
                      lib_pack = false;
                      lib_internal_modules = [];
                      lib_findlib_parent = None;
                      lib_findlib_name = Some "raft_spl";
               ...
               Executable
                 ({
                   ...
                   {exec_custom = false; exec_main_is = "cmdstart.ml"});
               Executable
                 ({
                     cs_name = "configstart";
                     cs_data = PropList.Data.create ();
                   ...
                   {exec_custom = false; exec_main_is = "config.ml"});
               Executable
                 ({
                     cs_name = "jsonstart";
                     cs_data = PropList.Data.create ();
                   ...
                   {exec_custom = false; exec_main_is = "jparser.ml"})
            ];
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "stfô\142\r\1543Mæ\132è\000\r\030\159";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
