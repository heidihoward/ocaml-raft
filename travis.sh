...
./cmdstart.byte discrete -termOnClient -nodes 5 -d -follower Uniform-150-300 -candidate Uniform-150-300 -leader Fixed-75 -delay Normal-7-3
./cmdstart.byte discrete -termOnClient -nodes 5 -d -follower Uniform-150-300 -candidate Uniform-150-300 -leader Fixed-75 -delay Normal-7-3 -cmds 50 -loss 0.1
./cmdstart.byte discrete -termOnClient -nodes 10 -d -follower Uniform-150-300 -candidate Uniform-150-300 -leader Fixed-75 -delay Normal-7-3 -cmds 50 -failure Uniform-0-1000 -recover Uniform-5-10
